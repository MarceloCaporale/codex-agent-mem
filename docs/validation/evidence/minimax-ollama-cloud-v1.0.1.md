# Minimax via Ollama Cloud Evidence - v1.0.1
...
| Model/backend | `minimax-m2.5:cloud` through Ollama Cloud |
...
| Runtime health | `server_version=1.0.1`, requests increased, `not_modified=true` observed |
